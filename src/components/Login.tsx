...
const Login: React.FC<LoginProps> = ({ mode = 'user' }) => {
  ...
  const { login, signup, loginWithGoogle, loginWithFacebook, state } = useAuth();
            ...
            <>
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 glass-morphism text-gray-400">Or continue with</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <button
                  ...
                  type="button"
                  className="glass-button flex items-center justify-center space-x-2 py-3 hover:bg-white/5 transition-all"
                >
<svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
          ...
          {isAdminMode && (
            <div className="mt-4 mobile-card p-3 text-left">
              ...
              <p className="text-xs text-gray-400">Password: Create in Firebase Console or use social login</p>
            </div>
          )}
